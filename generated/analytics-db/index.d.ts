...
export namespace Prisma {
  ...
  */
  ...
  export type AnalyticsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"uuid" | "on", ExtArgs["result"]["analytics"]>
  ...
  export interface AnalyticsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> {
     ...
     * const analyticsWithUuidOnly = await prisma.analytics.findMany({ select: { uuid: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Analytics and only return the `uuid`
     * const analyticsWithUuidOnly = await prisma.analytics.createManyAndReturn({
     *   select: { uuid: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Analytics and only return the `uuid`
     * const analyticsWithUuidOnly = await prisma.analytics.updateManyAndReturn({
     *   select: { uuid: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface AnalyticsFieldRefs {
    ...
    readonly on: FieldRef<"Analytics", 'Boolean'>
  }
  ...
  export type AnalyticsWhereInput = {
    ...
    on?: BoolFilter<"Analytics"> | boolean
  }
  ...
  export type AnalyticsScalarWhereWithAggregatesInput = {
    ...
    on?: BoolWithAggregatesFilter<"Analytics"> | boolean
  }
